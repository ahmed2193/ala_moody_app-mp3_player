...
import 'package:alamoody/core/utils/dialogs/confirm_plan_dialog.dart';
...
class Constants {
  ...
  static Future<void> subscribeToPlans(
    ...
    return showDialog(
      context: context,
      builder: (BuildContext context) => ConfirmationPlanDialog(
        alertMsg: messageTxt,
        // AppLocalizations.of(context)!.translate('do_u_want_cancel_plan')!,
        onTapConfirm: () {
          planName.contains('Free Plan') || planName.contains('Plan 1')

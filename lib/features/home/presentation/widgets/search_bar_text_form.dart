      ...
      child: SizedBox(
        ...
        child: TextFormField(
          ...
          style: Theme.of(context)
              .textTheme
              .bodyLarge!
              .copyWith(fontSize: responsiveFontSize),
          decoration: InputDecoration(
            ...
            filled: true,
            fillColor:
                Theme.of(context).listTileTheme.textColor!.withOpacity(.12),
            ...
            contentPadding: EdgeInsets.symmetric(
                horizontal: paddingSize * 1.5, vertical: 10), // Reduced padding
            enabledBorder: OutlineInputBorder(
              borderSide: BorderSide(
                color:
                    Theme.of(context).listTileTheme.textColor!.withOpacity(.4),
              ),
              borderRadius:
                  BorderRadius.circular(10.0), // Slightly rounded edges
            ),

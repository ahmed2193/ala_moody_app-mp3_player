                    ...
                    child: Column(
                      children: [
                        if (context.read<ProfileCubit>().userProfileData != null &&
                            context.read<ProfileCubit>().userProfileData!.user!.subscription!.serviceId == '1')
                          Row(
                    ...
                    child: search != null
                        ? TabBarReuse(
                            names: [
                              ...
                              AppLocalizations.of(context)!.translate("podcast")!,
                              AppLocalizations.of(context)!.translate("audioBook")!,
